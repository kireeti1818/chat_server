...
socket.addEventListener('message', function (event) 
{
  if(event.data.trim()=="__false__")
  {
    ...
    alert("userName already exists");
      ...
      chatBox.innerHTML ="<div><input checked type=\"radio\" id=\"broadcast\" name=\"mode_type\"\
                          value=\"broadcast\">\<label for=\"broadcast\" >broadcast</label><input type=\"radio\"\
                           id=\"private\" name=\"mode_type\" value=\"private\"><label for=\"private\">\
                           private chat  </label><button id=\"userButton\" type=\"button\" \
                           onclick=\"change_mode()\">Change mode</button><br></div><div id=\"userName_send\">\
                           <span style=\"color:red;\"><b> <i> broadcasting</i> the message</b></span></div>\
                           <div id=\"main_div\"><div id=\"output\"></div><div id=\"send\"><textarea \
                           name=\"message\"  id=\"inputField\" rows=\"4\" cols=\"40\"></textarea>\
